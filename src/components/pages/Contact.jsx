                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                        <div className="w-full md:w-1/1">
                            ...
                            >
                                ...
                                <div className="flex flex-row justify-between items-center space-x-4 mb-8 overflow-x-auto">
                                    <motion.div 
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:ravindramahto2009@gmail.com" className="text-gray-300 hover:text-green-400 transition-colors duration-300">
                                               ravindramahto2009@gmail.com
                                            </a>
                                        </div>
                                    </motion.div>
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <a href="tel:+8210923978" className="text-gray-300 hover:text-green-400 transition-colors duration-300">
                                                +91 8210923978
                                            </a>
                                        </div>
                                    </motion.div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                                    <motion.div 
                                        ...
                                        className="bg-gradient-to-r from-orange-500/5 to-green-500/5 p-6 rounded-lg hover:from-orange-500/10 hover:to-green-500/10 transition-all duration-300"
                                    >
                                        <h3 className="text-xl font-semibold mb-4 bg-gradient-to-r from-orange-500 to-green-500 text-transparent bg-clip-text">
                                            Contact Details
                                        </h3>
                                        <ul className="space-y-3">
                                            <li className="flex items-center text-gray-300 hover:text-white transition-colors">
                                                <span className="w-2 h-2 bg-gradient-to-r from-orange-500 to-green-500 rounded-full mr-2"></span>
                                    ...
                                    >
                                        ...
                                        <ul className="space-y-3">
                                            ...
                                            <li className="flex items-center text-gray-300 hover:text-white transition-colors">
                                                <span className="w-2 h-2 bg-gradient-to-r from-orange-500 to-green-500 rounded-full mr-2"></span>
                                                Available for Emergency Contacts
                                            </li>
                                        </ul>
                                    </motion.div>
                                </div>
